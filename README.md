...
# Alternatively, send notifications to a channel:
# DAILY_SIGNAL_DISCORD_CHANNEL_ID=your-discord-channel-id
# Override only when the public site uses a different HTTPS origin:
# DAILY_SIGNAL_PUBLIC_BASE_URL=https://blog.nightly.dedyn.io
